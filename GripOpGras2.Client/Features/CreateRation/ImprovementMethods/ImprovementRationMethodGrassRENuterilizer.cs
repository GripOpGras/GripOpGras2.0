namespace GripOpGras2.Client.Features.CreateRation.ImprovementMethods
{
	...
	/// #TODO: return not only 1 improvementRapport, but a few for these catogories: 1. Best improvement with roughages (if possible), 2. Best improvement in KGDM improvement per KGDM Supplementary, 3. Best improvement per VEM.
	/// </summary>
