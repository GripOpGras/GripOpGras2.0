...
Scenario: Create a ration for a herd, when having two roughage products
	Given I have the roughage product <roughage1> that contains <re-roughage1> g protein, and <vem-roughage1> VEM
	And I have the roughage product <roughage2> that contains <re-roughage2> g protein, and <vem-roughage2> VEM
...
Examples: 
| roughage1 | re-roughage1 | vem-roughage1 | roughage2 | re-roughage2 | vem-roughage2 | herd-size | grass-intake | vem-grass | protein-grass | lmilk-produced | kg-roughage1-min | kg-roughage1-max |kg-roughage2-min |kg-roughage2-max |
| kuilgras  | 160          | 920           | mais      | 60           | 960           | 100       | 1062.5       | 1000      | 210           | 3000           |                  | 275              |                 | 708             |

Scenario: Create a ration for a herd, when having three roughage products
	Given I have the roughage product <roughage1> that contains <re-roughage1> g protein, and <vem-roughage1> VEM
	And I have the roughage product <roughage2> that contains <re-roughage2> g protein, and <vem-roughage2> VEM
	And I have the roughage product <roughage3> that contains <re-roughage3> g protein, and <vem-roughage3> VEM
	And I have a herd with <herd-size> cows in it, which have taken in <grass-intake> kg dm grass
	And each kg dm grass contains <vem-grass> VEM and <protein-grass> g protein
	And my herd has produced <lmilk-produced> liters of milk
	When I let Grip op Gras 2 create a ration
	...
	And the ration must contain <grass-intake> kg of grass
Examples: 
| roughage1 | re-roughage1 | vem-roughage1 | roughage2 | re-roughage2 | vem-roughage2 | roughage3 | re-roughage3 | vem-roughage3 | herd-size | grass-intake | vem-grass | protein-grass | lmilk-produced | kg-roughage1-min | kg-roughage1-max |kg-roughage2-min |kg-roughage2-max | kg-roughage3-min | kg-roughage3-max |
...
Scenario: Create a ration for a herd, when having three roughage products and two supplementary product
	...
	And I have the roughage product <roughage2> that contains <re-roughage2> g protein, and <vem-roughage2> VEM
	And I have the roughage product <roughage3> that contains <re-roughage3> g protein, and <vem-roughage3> VEM
	And I have the supplementary product <supplementary1> that contains <re-supplementary1> g protein, and <vem-supplementary1> VEM
	And I have the supplementary product <supplementary1> that contains <re-supplementary2> g protein, and <vem-supplementary2> VEM
	And I have a herd with <herd-size> cows in it, which have taken in <grass-intake> kg dm grass
	And each kg dm grass contains <vem-grass> VEM and <protein-grass> g protein
	And my herd has produced <lmilk-produced> liters of milk
	When I let Grip op Gras 2 create a ration
	...
	And the ration must contain <grass-intake> kg of grass
Examples: 
| roughage1 | re-roughage1 | vem-roughage1 | roughage2 | re-roughage2 | vem-roughage2 | roughage3 | re-roughage3 | vem-roughage3 | supplementary1 | re-supplementary1 | vem-supplementary1 | supplementary2 | re-supplementary2 | vem-supplementary2 | herd-size | grass-intake | vem-grass | protein-grass | lmilk-produced | kg-roughage1-min | kg-roughage1-max |kg-roughage2-min |kg-roughage2-max | kg-roughage3-min | kg-roughage3-max | kg-supplementary1-min | kg-supplementary1-max | kg-supplementary2-min | kg-supplementary2-max |
...
Scenario: Create a ration for a herd, when having two roughage products and one supplementary product
	...
	And the ration must contain <grass-intake> kg of grass
Examples:
| roughage1 | re-roughage1 | vem-roughage1 | roughage2 | re-roughage2 | vem-roughage2 | supplementary1 | re-supplementary1 | vem-supplementary1 | herd-size | grass-intake | vem-grass | protein-grass | lmilk-produced | kg-roughage1-min | kg-roughage1-max |kg-roughage2-min |kg-roughage2-max | kg-supplementary1-min | kg-supplementary1-max |
...
Scenario: Create a ration for a herd when haven't grazed today and having two roughage products
	...
	And my herd has produced <lmilk-produced> liters of milk
	And I have the roughage product <roughage1> that contains <re-roughage1> g protein, and <vem-roughage1> VEM
	And I have the roughage product <roughage2> that contains <re-roughage2> g protein, and <vem-roughage2> VEM
	When I let Grip op Gras 2 create a ration
	Then the ration should contain between <kg-roughage1-min> and <kg-roughage1-max> kg dm of <roughage1>
	And the ration should contain between <kg-roughage2-min> and <kg-roughage2-max> kg dm of <roughage2>
...
Examples: 
| herd-size | lmilk-produced | roughage1 | re-roughage1 | vem-roughage1 | roughage2 | re-roughage2 | vem-roughage2 | kg-roughage1-min | kg-roughage1-max | kg-roughage2-min | kg-roughage2-max |
