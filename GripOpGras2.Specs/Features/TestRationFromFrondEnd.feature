...
Scenario: The user requests an ration from the home page and gets an error message
	Given that I am logged into the application
	And I am on the home page
	And I have <amountProducts> Products and 0 Supplementary Feedproducts that should be able to make a correct Ration
	And I have a herd with 59 cows which have produced a total of 5000.6 L milk
	And the herd has grazed 123 KG Dm of grass with 904 VEM and 180 Re per Kg Dm
	When I request the ration
	Then the page should contain an error message within 10 seconds
	Examples: 
	| amountProducts |
	| 0              |
	| 1              |
